...
const Product = () => {
  ...
  return productData ?(
    <div className='border-t-2 pt-10 transition-opacity ease-in duration-500 opacity-100'>
      {/* -----Product Data---- */}
      <div className='flex w-full gap-12 sm:gap-12 flex-col sm:flex-row'>
        {/* ---Product Images---- */}
      ...
      <div className='mt-20'>
        ...
        <div className='flex flex-col py-6 px-6 gap-4 border text-sm text-gray-500'>
          <p>"Quality Products, Great Deals & Reliable Service – All in One Place!
